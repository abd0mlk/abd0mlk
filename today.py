...
USER_NAME = os.environ['USER_NAME'] # 'abd0mlk'
...
if __name__ == '__main__':
    """
    Abdullah Malik (abd0mlk), 2022-2024
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2007, 10, 18))
    ...
    if OWNER_ID == {'id': 'U_kgDOCARV4w'}: # only calculate for user abd0mlk
